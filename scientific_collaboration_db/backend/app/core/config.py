...
class Settings(BaseSettings):
    ...
    # Forgot-password reset link lifetime
    ...
    # Local file storage for uploaded publication PDFs and avatar images.
    # Stored on disk under this folder (relative to where uvicorn runs from)
    # and served back out at /uploads/... — see app/main.py's StaticFiles mount.
    UPLOAD_DIR: str = "uploads"
    MAX_PUBLICATION_FILE_MB: int = 15
    MAX_AVATAR_FILE_MB: int = 3
