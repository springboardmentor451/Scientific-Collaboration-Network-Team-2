...
class Project(Base):
    ...
    # An explicit, admin/lead-editable completion percentage (0-100). Falls
    # back to a status-derived estimate on the frontend only when this is
    # left unset, so a project's progress no longer has to be guessed.
